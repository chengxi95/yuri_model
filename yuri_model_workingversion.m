...
for rr= 1
    ...
    Isyn_aPFC_D_MD = zeros(numberofneurons,length(T));
    Isyn_pPFC_D_MD = zeros(numberofneurons,length(T));
    Isyn_MD_to_inh = zeros(numberofneurons,length(T));
    Isyn_MD_to_inh_PV = zeros(numberofneurons,length(T));
    Isyn_MD1_to_aPFC= ones(numberofneurons,length(T));
    Isyn_MD2_to_pPFC = ones(numberofneurons,length(T));
    ...
    for i= 2:length(T)
        ...
        for jj=1:numberofneurons
            q=0;
            for kk=1:numberofneurons
                if (i-last_spike_MD(kk))<(spikewidth_MD) && (i-last_spike_MD(kk))> 0 %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    if matrix_MD_to_Crtex(kk,jj)~=0
                        q=q+1;
                        spike_count(jj, i)=q;
                        Isyn_MD1_to_aPFC(jj,i+ delay)= amplification;% md_coefficient* spike_count(jj, i);
                    end
                end
            end
        end
        ...
        for jj=1:numberofneurons
            q=0;
            for kk=1:numberofneurons
                if (i-last_spike_VA_matrix(kk))<(spikewidth_MD) && (i-last_spike_VA_matrix(kk))> 0 %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    if matrix_MD_to_Crtex(kk,jj)~=0
                        q=q+1;
                        spike_count(jj, i)=q;
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_aPFC_D6(kk))<(spikewidth) && (i-last_spike_aPFC_D6(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    if PFC_MD_matrix(kk,jj)~=0
                        Isyn_aPFC_D_MD(jj,i+ delay)=Isyn_aPFC_D_MD(jj,i+ delay)+PFC_MD_matrix(kk,jj);
                    end
                end
            end
        end
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_aPFC_D(kk))<(spikewidth) && (i-last_spike_aPFC_D(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    if PFC_VA_matrix(kk,jj)~=0
                        Isyn_aPFC_D5(jj,i+ delay)= Isyn_aPFC_D5(jj,i+ delay) + W_PFC_MD;
                    end
                end
            end
        end
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_aPFC_D_GC(kk))<(spikewidth) && (i-last_spike_aPFC_D_GC(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    ...
                    Isyn_aPFC_D5_shape(jj,i+ delay)= Isyn_aPFC_D5_shape(jj,i+ delay) + W_PFC_MD;
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_aPFC_D(kk))<(spikewidth) && (i-last_spike_aPFC_D(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    ...
                    Isyn_aPFC_D5_toremote(jj,i+ delay)=Isyn_aPFC_D5_toremote(jj,i+ delay) + 0.3*W_PFC_MD;%%%%%%%%%%%%%%%%%%%%%                      hard coding
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_VA_matrix(kk))<(spikewidth) && (i-last_spike_VA_matrix(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
        ...
        for jj=1:numberofneurons
            for kk=1:numberofneurons
                if (i-last_spike_pPFC_D(kk))<(spikewidth) && (i-last_spike_pPFC_D(kk))> 0  %%%%%%%%%%%%%%%%%%%%%%%%%%delay ==0
                    if PFC_MD_matrix(kk,jj)~=0
                        Isyn_pPFC_D_MD(jj,i+ delay)=Isyn_pPFC_D_MD(jj,i+ delay)+ PFC_MD_matrix(kk,jj);
                    end
                end
            end
        end
