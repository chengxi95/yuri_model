...
for rr= 1
    ...
    for i= 2:length(T)
       ...
       %%%%  ORIENTATION
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PFC deep  to MD 
% SHAPE 
        Isyn_PFC_D_MD_shape(:,i+ delay) = Isyn_PFC_D_MD_shape(:,i+ delay) + W_PFC_MD .* sum(((i-last_spike_PFC_D_BT<spikewidth) & (i-last_spike_PFC_D_BT>0) & (matrix_M ~= 0)), 1).';
        
        Isyn_PFC_D_MD_shape(:,i+ delay) = Isyn_PFC_D_MD_shape(:,i+ delay) + W_PFC_MD .* sum(((i-last_spike_aPFC_D_RC<spikewidth) & (i-last_spike_aPFC_D_RC>0) & (matrix_M ~= 0)), 1).';

        Isyn_PFC_D_MD_shape(:,i+ delay) = Isyn_PFC_D_MD_shape(:,i+ delay) + 3 * W_PFC_MD .* sum(((i-last_spike_pPFC_remote_shape<spikewidth) & (i-last_spike_pPFC_remote_shape>0) & (matrix_M ~= 0)), 1).';

% ORIENTATION 

        Isyn_PFC_D_MD_ori(:,i+ delay) = Isyn_PFC_D_MD_ori(:,i+ delay) + W_PFC_MD .* sum(((i-last_spike_aPFC_D_YT<spikewidth) & (i-last_spike_aPFC_D_YT>0) & (matrix_M ~= 0)), 1).';

        Isyn_PFC_D_MD_ori(:,i+ delay) = Isyn_PFC_D_MD_ori(:,i+ delay) + W_PFC_MD .* sum(((i-last_spike_aPFC_D_GC<spikewidth) & (i-last_spike_aPFC_D_GC>0) & (matrix_M ~= 0)), 1).';

        Isyn_PFC_D_MD_ori(:,i+ delay) = Isyn_PFC_D_MD_ori(:,i+ delay) + W_PFC_MD .* sum(((i-last_spike_pPFC_remote_Orientation<spikewidth) & (i-last_spike_pPFC_remote_Orientation>0) & (matrix_M ~= 0)), 1).';
        ...
        Isyn_VA_Matrix_to_PFC_exc_shape(:,i+ delay) = Isyn_VA_Matrix_to_PFC_exc_shape(:,i+ delay) +  W_VA_exi .* sum(((i-last_spike_VA_matrix_shape<spikewidth_MD) & (i-last_spike_VA_matrix_shape>0) & (matrix_VA_to_rule ~= 0)), 1).';
        
        Isyn_VA_Matrix_to_PFC_exc_orientation(:,i+ delay) = Isyn_VA_Matrix_to_PFC_exc_orientation(:,i+ delay) +  W_VA_exi .* sum(((i-last_spike_VA_matrix_Orientation<spikewidth_MD) & (i-last_spike_VA_matrix_Orientation>0) & (matrix_VA_to_rule ~= 0)), 1).';
        ...
        Isyn_MD_shape_to_PFC(:,i+ delay) = Isyn_MD_shape_to_PFC(:,i+ delay) +  W_MD_PFC .* sum(((i-last_spike_MD_shape<spikewidth) & (i-last_spike_MD_shape>0) & (matrix_local ~= 0)), 1).'; 
        ...
        Isyn_MD_to_Inh(:,i+ delay) = Isyn_MD_to_Inh(:,i+ delay) + W_MD_inh .* sum(((i-last_spike_MD_shape<spikewidth_MD) & (i-last_spike_MD_shape>0)), 1).';
